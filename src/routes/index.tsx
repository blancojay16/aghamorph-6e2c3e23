...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Aghamorph — Explore the Human Body" },
      { name: "description", content: "Learn about the human body systems with fun videos and games." },
    ],
  }),
  component: Index,
});
...
// keep referenced for tree-shaking helpers
void systemMeta;
