...
-- Anyone (students included, unauthenticated) can read the catalog
...
-- Storage bucket for video files (public read so students can stream without auth)
